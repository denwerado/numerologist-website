...
gulp.task('svgstore', function () {
    return gulp.src('./assets/images/_svg/*.svg')
        .pipe(svgmin())
...
gulp.task('build-js', ()=>{
    ...
    return browserify('./assets/scripts/main.js',{debug: false})//debug: true Подключение опции ориентировки
...
gulp.task('watch', ()=>{
    ...
    gulp.watch('./assets/images/_svg/*.svg', gulp.parallel('svgstore'));
    gulp.watch('./assets/scripts/main.js', gulp.parallel('build-js'));
});
